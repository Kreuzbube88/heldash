...
interface InstanceState {
  ...
  createInstance: (data: { type: InstanceType; name: string; url: string; token?: string; api_key?: string; username?: string; enabled?: boolean; icon_id?: string | null }) => Promise<Instance>
  updateInstance: (id: string, data: { name?: string; url?: string; token?: string; api_key?: string; username?: string; enabled?: boolean; icon_id?: string | null }) => Promise<void>
